...
class Logger(object):
    ...
    def save_as_csv(self,
        ...
        csv_dir = "./results/rl-train/plt/" + comment
    ...
    def plot(self, name="output.png", pwm=False):
            """Logs entries for a single simulation step, of a single drone.
            ...
            if self.COLAB: 
                plt.savefig(os.path.join('results', "output.png"))
            else:
                plt.show()
